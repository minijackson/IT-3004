...
namespace matrix {
	...
	template <typename Connections>
	std::vector<bool>::reference GenericNode<Connections>::operator[](size_t otherId) {
	...
	template <typename Connections>
	void GenericNode<Connections>::connectTo(size_t otherId) {
		connections[otherId] = true;
	}

	template <typename Connections>
	void GenericNode<Connections>::disconnectFrom(size_t otherId) {
